...
class Transaction(models.Model):
	...
	machine_id		 = 		models.ForeignKey(Machine)
	DateTimeField    = 		models.IntegerField("TRANSACTION ID",primary_key=True)
	date_time		 = 		models.DateTimeField("DATE TIME OF TRANSACTION")
	card_status      = 		models.CharField("STATUS",max_length = 100)
...
## Cash_Transfer() is the inherited class of transaction class
## It has 3 fields
